...
class LanguageSelectViewController: UIViewController {
    ...
    @IBAction func sinhalaBtn(_ sender: UIButton) {
        ...
        tamilBtn.backgroundColor = UIHelper.colorWithHexString(hex: "#4D4D4D")
        englishBtn.backgroundColor = UIHelper.colorWithHexString(hex: "#4D4D4D")
    ...
    @IBAction func tamilBtn(_ sender: UIButton) {
        sinhalaBtn.backgroundColor = UIHelper.colorWithHexString(hex: "#4D4D4D")
