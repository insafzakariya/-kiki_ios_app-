...
open class CachedImageView: UIImageView {
    ...
    public init(cornerRadius: CGFloat = 0, emptyImage: UIImage? = nil) {
        ...
        self.emptyImage = UIImage(named: "logo_grayscale_video")//emptyImage
    }
    ...
    required public init?(coder aDecoder: NSCoder) {
        ...
        self.emptyImage = UIImage(named: "logo_grayscale_video")
//        fatalError("init(coder:) has not been implemented")
    ...
    open func loadImage(urlString: String, completion: (() -> ())? = nil) {
        ...
        URLSession.shared.dataTask(with: url, completionHandler: { [weak self] (data, response, error) in
            if error != nil {
                self?.image = UIImage(named: "logo_grayscale_video")
                return
            }
