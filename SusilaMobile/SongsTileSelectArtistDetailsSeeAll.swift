//
//  SongsTileSelectArtistDetailsSeeAll.swift
//  SusilaMobile
//
...
class SongsTileSelectArtistDetailsSeeAll: UIView {
    ...
    var imageURL = "" {
        willSet {}
        didSet { //image.downloadImageBrowse(from: URL(string: imageURL)!)
    ...
    private func commonInit() {
        ...
        time = UILabel(frame: CGRect(x: image.frame.width+10, y: lblTitle.frame.height+30, width: self.frame.width-20, height: 20))
        time.textColor = .gray
