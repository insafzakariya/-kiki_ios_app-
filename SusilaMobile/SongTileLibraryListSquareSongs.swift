//
//  SongTileLibraryListSquareSongs.swift
//  SusilaMobile
//
...
class SongTileLibraryListSquareSongs: UIView {
...
extension UIImageView{
    func getDataSongTileLibraryListSquareSongs(from url: URL, completion: @escaping (Data?, URLResponse?, Error?) -> ()) {
        URLSession.shared.dataTask(with: url, completionHandler: completion).resume()
    }
    func downloadImageSongTileLibraryListSquareSongs(from url: URL) {
        getDataSongTileLibraryListSquareSongs(from: url) { data, response, error in
